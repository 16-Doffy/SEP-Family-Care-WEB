...
import { Bell, Siren, ArrowLeft } from 'lucide-react'
 ...
 * @param backHref - Nếu có, hiển thị nút back trên mobile dẫn về route này (Link push).
 *                   Nếu = `true` (string không khả dụng), dùng router.back() thay thế.
 */
