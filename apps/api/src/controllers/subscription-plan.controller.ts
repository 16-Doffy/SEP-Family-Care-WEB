...
const planSchema = z.object({
  ...
  albumStorageMb: z.number().int().nonnegative().nullable().optional(),
  systemStorageMb: z.number().int().nonnegative().nullable().optional(),
  aiEnabled: z.boolean().optional(),
  aiFinanceEnabled: z.boolean().optional(),
